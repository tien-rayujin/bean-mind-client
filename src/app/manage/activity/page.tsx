...
import { FilterActivityButton } from "./components/Button";
...
const Page: React.FC<ActivityPageProps> = async (props) => {
  ...
  return (
    <div className="relative h-full">
      ...
      <ActivityTable pageIndex={pageIndex} pageSize={pageSize} term={term} />
    </div>
  );
};
