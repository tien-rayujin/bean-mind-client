...
interface WorksheetTemplateDetailLayoutProps extends PropsWithChildren {
  modal: React.ReactNode;
  params: { id: string };
}

const Layout: React.FC<WorksheetTemplateDetailLayoutProps> = async (props) => {
  ...
  const { isDeleted } = worksheetTemplate;
  ...
  return (
    <div className="relative h-full">
      ...
      <div className="flex h-full max-h-full flex-col overflow-y-hidden">
        <Breadcrumb pageName="WorksheetTemplate Detail" />
