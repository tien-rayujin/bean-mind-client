...
const Page: React.FC<PackagePageProps> = async (props) => {
  ...
  return (
    <div className="relative h-full">
      ...
      <section className="mb-4 w-full rounded-md bg-background/30 p-4 shadow-md">
        ...
        <div className="mb-4 flex items-center gap-4">
          ...
          <Link href={"package/create"}>
            <CreateButton text="Create package" extras="h-12" />
          </Link>
          <FilterButton />
          <ReloadButton />
        </div>
      ...
      <PackageTable pageIndex={pageIndex} pageSize={pageSize} term={term} />
    </div>
  );
};
