...
import TeachingSlotTable from "./components/Table";
import {
  CreateButton,
  FilterButton,
  ReloadButton,
...
interface TeachingSlotPageProps {
  searchParams: {
    pageIndex: string;
    pageSize?: string;
    term?: string;
...
const Page: React.FC<TeachingSlotPageProps> = async (props) => {
  ...
  return (
    <div className="relative h-full">
      <Breadcrumb pageName="TeachingSlot" />
