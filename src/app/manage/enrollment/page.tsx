...
const Page: React.FC<EnrollmentPageProps> = async (props) => {
  ...
  return (
    <div className="relative h-full">
      <Breadcrumb pageName="Enrollment" />
      ...
      <section className="mb-4 w-full rounded-md bg-background/30 p-4 shadow-md">
        ...
        <div className="mb-4 flex items-center gap-4">
          ...
          <Link href={"enrollment/create"}>
            <CreateButton text="Create enrollment" extras="h-12" />
          </Link>
          <FilterButton />
          <ReloadButton />
        </div>
      ...
      <EnrollmentTable pageIndex={pageIndex} pageSize={pageSize} term={term} />
    </div>
  );
};
