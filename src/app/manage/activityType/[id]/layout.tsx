...
interface ActivityTypeDetailLayoutProps extends PropsWithChildren {
  modal: React.ReactNode;
  params: { id: string };
}

const Layout: React.FC<ActivityTypeDetailLayoutProps> = async (props) => {
  ...
  return (
    <div className="relative h-full">
      ...
      <div className="flex h-full max-h-full flex-col overflow-y-hidden">
        <Breadcrumb pageName="ActivityType Detail" />
