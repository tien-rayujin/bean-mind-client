...
const config: Config = {
  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        authBackground: "url('/assets/background/mountain_background.jpg')",
        sunsetBackground: "url('/assets/background/sunset-background.jpg')",
      },
      boxShadow: {
        lightBulp: "0 20px 80px -10px rgba(var(--primary));",
        layoutPopup: "0 0 10px rgba(255, 255, 255, 0.1);",
      },
      dropShadow: {
